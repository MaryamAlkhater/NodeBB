...
async function finalizeUserData(userData, results, callerUID) {
	const { isAdmin, isGlobalModerator, isModerator, isSelf } = results;
	...
	userData.profile_links = filterLinks(results.profile_menu.links, getProfileLinkOptions(isSelf, isModerator, isGlobalModerator, isAdmin, canViewInfo));
